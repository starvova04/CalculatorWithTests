...
public class CalcImplTest {
    ...
    void shouldProcessTaskCorrectly() {
        ...
        // THEN
        assertThat(result, containsString("Total args: 5"));
        assertThat(result, containsString("Number args: 4"));
        assertThat(result, containsString("Max number: 45"));
    }

    @Test
    void shouldHandleTaskWithNoNumbers() {
        // GIVEN
        String[] args = {"a", "b", "+", "c"};
        ...
        // THEN
        assertThat(result, containsString("Total args: 4"));
        assertThat(result, containsString("Number args: 0"));
        assertThat(result, containsString("Max number: None"));
    }
}
